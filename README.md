...
The best general LLMs for computers with 8…16 GB of RAM in Oct 2024 are `gemma3` by Google (4B, 3.3GB), `llama3.2` by Meta (3B, 2.0GB), `phi3.5` by Microsoft (4B, 2.2GB), and `mistral` by MistralAI (7B, 4.1GB). See also: [ollama.com/models](https://ollama.com/models).
