...
The best general LLMs for computers with 8…16 GB of RAM in March 2025 are `gemma3:12b` by Google (12B, 8.1GB) and `llama3.1:8b` by Meta (8B, 4.9 GB). See also: [ollama.com/models](https://ollama.com/models).
